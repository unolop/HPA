#!/bin/bash
# Train on single train/val split with JS divergence loss

# Usage: ./train_single_split_js.sh <dataset_name> <model_path> <gpu_id>
...
OUTPUT_DIR="./output/single_split/JS_${MODEL##*/}_${DATASET}"
RUN_NAME="JS_${MODEL##*/}_${DATASET}"

echo "=========================================="
echo "Single Split Training (JS Divergence)"
echo "=========================================="
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python train_human_alignment.py \
    --model_path "${MODEL}" \
