...
Outputs
-------
- figures/entity_op_grouped_variants/hm_sbert_entity_op_grouped_variants_matched_7b.png
- figures/entity_op_grouped_variants/hm_sbert_entity_op_grouped_variants_all_models.png
- figures/entity_op_grouped_variants/hm_sbert_entity_op_grouped_variants_family_*.png
"""
...
OUT_DIR = ROOT / 'figures/entity_op_grouped_variants'
...
def main():
    ...
    plot_entity_op_grouped(pair_filt, meta, matched_models, 'matched_7b_filtered', drop_think=True)
    if args.all_models:
