...
Outputs go to figures/agreement/scale_main_panels_vABC/
and are copied to latex/AAAI2026/LaTeX/figures/scale_metrics_vABC/
"""
...
from helpers import clear_output_plots, get_exports_dir, load_cleaned_pair_cache, load_human_subset, read_export
...
OUT_DIR = ROOT / "figures/agreement/scale_main_panels_vABC"
OUT_DIR.mkdir(parents=True, exist_ok=True)

LATEX_OUT = ROOT / "latex/AAAI2026/LaTeX/figures/scale_metrics_vABC"
...
plt.tight_layout()
acc_fname = "inst_blind_accuracy_groups_vCBA_q113_h40_yesno.png"
fig.savefig(OUT_DIR / acc_fname, dpi=220, bbox_inches="tight")
fig.savefig(LATEX_OUT / acc_fname, dpi=220, bbox_inches="tight")
plt.close(fig)
print(f"Saved: {OUT_DIR / acc_fname}")
...
plt.tight_layout()
sbert_fname = "inst_blind_agreement_groups_sbert_vCBA_q113_h40_yesno.png"
fig.savefig(OUT_DIR / sbert_fname, dpi=220, bbox_inches="tight")
fig.savefig(LATEX_OUT / sbert_fname, dpi=220, bbox_inches="tight")
plt.close(fig)
print(f"Saved: {OUT_DIR / sbert_fname}")
