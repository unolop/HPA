...
Default output:
  figures/variant_ladders/
    inst_blind_accuracy_groups_3step_q88_h40.png
    inst_blind_sbert_groups_3step_q88_h40.png

With --include_yesno:
  figures/variant_ladders_yesno/
    inst_blind_accuracy_groups_3step_q113_h40_yesno.png
    inst_blind_sbert_groups_3step_q113_h40_yesno.png
