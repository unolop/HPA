...
def export_hh_boxplots(long_df: pd.DataFrame, q_tag: str) -> None:
    ...
    fig_op, ax_op = plt.subplots(figsize=(7.3, 3.8))
    ...
    ax_op.set_ylabel("HH SBERT", fontsize=15)
    ax_op.tick_params(axis='x', labelsize=15)
    ax_op.tick_params(axis='y', labelsize=14)
