...
Run from repo root:
  ...
  conda run -n zero python figures/hh_hm/variants_family.py --include_yesno
"""
...
parser.add_argument('--filter_abstentions', action='store_true',
                    help='Exclude pairs where either answer is a hard/soft abstention.')
