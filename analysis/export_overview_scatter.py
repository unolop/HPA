...
Run from repo root:
  conda run -n zero python analysis/export_overview_scatter.py --agg model_groups
  conda run -n zero python analysis/export_overview_scatter.py --agg model_family
"""
...
def save(fig, name: str):
    ...
    plt.close(fig)
    print(f'  [accuracy_scatter_{AGG}] {name}')
